...
public class Utility {
	 ...
	 * 解析和处理服务器返回的省级数据
	 */
	public synchronized static boolean handProvinceResponse(
	 ...
	 * 
	 */
	public static boolean handCityResponse(CoolWeatherDB coolWeatherDB,
	 ...
	 * 解析和返回县级数据
	 */
	public static boolean handCountyResponse(CoolWeatherDB coolWeatherDB,
